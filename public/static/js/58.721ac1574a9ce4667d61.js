...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/page/preAct/activeMode_5.vue
//
//
//
//
...
/* harmony default export */ var activeMode_5 = ({
  data() {
    ...
    doSubmit(type) {
      ...
      this.$refs.form.validate(valid => {
        if (valid) {
          ...
          let Arr = this.modeData.rule.rule.filter(function (item) {
            return item.money && item.prize;
          });
          let ruleArr = JSON.parse(JSON.stringify(Arr)); //防止再次进入组件时展示的数据是真实数据的100倍
          ...
          let formData = {
            ...
            rule_type: 'rescue_gold',
            rule: {
              template_id: this.modeData.rule.template_id ? this.modeData.rule.template_id : 5,
              rule: ruleArr,
...
/* scopeId */
var __vue_scopeId__ = "data-v-7cbd6497"
...
/* harmony default export */ var preAct_activeMode_5 = __webpack_exports__["default"] = (Component.exports);
