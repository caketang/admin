...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/page/preAct/activeMode_8.vue
//
//
//
//
...
/* harmony default export */ var activeMode_8 = ({
  data() {
        ...
        if (_this.seachData.type === 'edit') {
          ...
          _this.$http.get(editUrl, URLCONFIG).then(res => {
            if (res.data.state === 0 && res.data.data) {
              ...
              _this.modeData.rule.rule.minBetMoney = (formData.rule.rule.min_bet_money / 100).toString();

              _this.modeData.rule.rule.prize.pop();
    ...
    doSubmit(type) {
      ...
      this.$refs.form.validate(valid => {
        if (valid) {
          ...
          let Arr = this.modeData.rule.rule.prize.filter(function (item) {
            return item.times && item.money;
          });
          let ruleArr = JSON.parse(JSON.stringify(Arr));
          ...
          let formData = {
            ...
            rule: {
              template_id: 8,
              rule: {
                min_bet_money: parseInt(this.modeData.rule.rule.minBetMoney) * 100,
                prize: ruleArr
              },
...
/* scopeId */
var __vue_scopeId__ = "data-v-dca5ff46"
...
/* harmony default export */ var preAct_activeMode_8 = __webpack_exports__["default"] = (Component.exports);
