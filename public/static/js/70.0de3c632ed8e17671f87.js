...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/page/preAct/activeMode_4.vue
//
//
//
//
...
/* harmony default export */ var activeMode_4 = ({
  data() {
    ...
    return {
      ...
      rules: {
        ...
        'rule.luckydrawCondition[0].luckydraw': [{
          validator: validateConditionDepositPass,
          trigger: 'blur'
        }],
        title: [{
          required: true,
  ...
  components: {
    ...
    dateTimepPicker: dateTimePicker["a" /* default */]
  },
  methods: {
    init() {
      let _this = this;
          ...
          _this.$http.get(editUrl, URLCONFIG).then(res => {
            if (res.data.state === 0 && res.data.data) {
              ...
              _this.modeData = {
                ...
                rule: {
                  rule: [],
                  type: formData.rule.luckydraw_condition.type,
                  //抽奖条件
    ...
    handleCheckChange() {
      this.modeData.gameSelect = this.$refs.tree.getCheckedNodes(); //每次改变都验证一下游戏范围
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-f3eb8d44","hasScoped":true,"optionsId":"0","buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/page/preAct/activeMode_4.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"activeMode"}},[_c('el-col',{staticClass:"activeModeForm",attrs:{"span":14,"offset":5}},[_c('el-form',{ref:"form",staticClass:"mt20",attrs:{"model":_vm.modeData,"rules":_vm.rules,"label-width":"110px"}},[_c('el-col',{staticClass:"Layout",attrs:{"span":24}},[_c('h3',{staticClass:"tCent",domProps:{"textContent":_vm._s(_vm.LANG['规则设置'] || '规则设置')}}),_vm._v(" "),_c('el-form-item',{attrs:{"label":"优惠活动名称","prop":"name"}},[_c('el-input',{staticClass:"w80",attrs:{"placeholder":_vm.placename},model:{value:(_vm.modeData.name),callback:function ($$v) {_vm.$set(_vm.modeData, "name", $$v)},expression:"modeData.name"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"优惠类型","prop":"type_id"}},[_c('el-select',{staticClass:"w80",attrs:{"placeholder":"请选择类型"},model:{value:(_vm.modeData.type_id),callback:function ($$v) {_vm.$set(_vm.modeData, "type_id", $$v)},expression:"modeData.type_id"}},_vm._l((_vm.type_idList),function(item,index){return _c('el-option',{key:item.index,attrs:{"label":item.label,"value":item.value}})}),1)],1),_vm._v(" "),_c('el-form-item',{staticClass:"w80",attrs:{"label":"有效时间","required":""}},[_c('el-col',{staticClass:"w30"},[_c('el-form-item',{attrs:{"prop":"begin_time"}},[_c('dateTimePicker',{attrs:{"datekey":'begin_time'},on:{"get-val":_vm.timeChange},model:{value:(_vm.modeData.begin_time),callback:function ($$v) {_vm.$set(_vm.modeData, "begin_time", $$v)},expression:"modeData.begin_time"}})],1)],1),_vm._v(" "),_c('div',{staticClass:"w20 tCent",staticStyle:{"float":"left"}},[_vm._v(" - ")]),_vm._v(" "),_c('el-col',{staticClass:"w30"},[_c('el-form-item',{attrs:{"prop":"end_time"}},[_c('dateTimePicker',{attrs:{"datekey":'end_time'},on:{"get-val":_vm.timeChange},model:{value:(_vm.modeData.end_time),callback:function ($$v) {_vm.$set(_vm.modeData, "end_time", $$v)},expression:"modeData.end_time"}})],1)],1)],1),_vm._v(" "),(_vm.seachData.type=='add')?_c('el-form-item',{attrs:{"label":"发放奖金","prop":"rule.issueMode"}},[_c('el-radio-group',{model:{value:(_vm.modeData.rule.issueMode),callback:function ($$v) {_vm.$set(_vm.modeData.rule, "issueMode", $$v)},expression:"modeData.rule.issueMode"}},[_c('el-radio',{staticClass:"radio",attrs:{"label":"auto"}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['自动发放'] || '自动发放')}})]),_vm._v(" "),_c('el-radio',{staticClass:"radio",attrs:{"label":"manual"}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['手动发放'] || '手动发放')}})])],1)],1):_vm._e(),_vm._v(" "),_c('el-form-item',{ref:"rule",staticClass:"w90",attrs:{"label":"优惠规则","required":"","prop":"rule.rule"}},[_c('el-col',{attrs:{"span":24}},[_c('el-row',[_c('el-col',{attrs:{"span":8}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['优惠金额'] || '优惠金额')}})]),_vm._v(" "),_c('el-col',{attrs:{"span":9}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['权重'] || '权重')}})])],1),_vm._v(" "),_vm._l((_vm.modeData.rule.rule),function(item,key){return _c('div',[_c('div',{staticClass:"clear",staticStyle:{"padding-bottom":"15px"}},[_c('el-col',{attrs:{"span":8}},[_c('el-form-item',{attrs:{"prop":'rule.rule['+key+'].prize',"rules":[{ validator:_vm.validatorNumber,trigger:'blur'}]}},[_c('span',[_vm._v(_vm._s(key))]),_vm._v(" "),_c('el-input',{staticClass:"intW",on:{"blur":_vm.ruleBlur},model:{value:(item.prize),callback:function ($$v) {_vm.$set(item, "prize", $$v)},expression:"item.prize"}})],1)],1),_vm._v(" "),_c('el-col',{attrs:{"span":9}},[_c('el-form-item',{attrs:{"prop":'rule.rule['+key+'].weight',"rules":[{ validator:_vm.validatorNumber,trigger:'blur'}]}},[_c('el-input',{staticClass:"intW",on:{"blur":_vm.ruleBlur},model:{value:(item.weight),callback:function ($$v) {_vm.$set(item, "weight", $$v)},expression:"item.weight"}}),_vm._v(" "),(key === 0)?_c('i',{staticClass:"el-icon-plus",staticStyle:{"padding":"10px","background":"#ccc"},on:{"click":function($event){return _vm.addPrizeRule(key,0)}}}):_c('i',{staticClass:"el-icon-minus",staticStyle:{"padding":"10px","background":"#ccc"},on:{"click":function($event){return _vm.deletePrizeRule(key,0)}}})],1)],1)],1)])})],2)],1),_vm._v(" "),_c('el-form-item',{staticClass:"w100",attrs:{"label":"抽奖条件","prop":"rule.type"}},[_c('el-radio-group',{staticClass:"radio-group",on:{"change":function($event){return _vm.typeChange()}},model:{value:(_vm.modeData.rule.type),callback:function ($$v) {_vm.$set(_vm.modeData.rule, "type", $$v)},expression:"modeData.rule.type"}},[_c('el-radio',{staticClass:"lottery-condition radio",attrs:{"label":"1"}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['以存款为条件'] || '以存款为条件')}}),_vm._v(" "),_vm._l((_vm.modeData.rule.luckydrawCondition[0].luckydraw),function(item,key){return _c('div',{staticClass:"clear",staticStyle:{"padding-bottom":"15px"}},[_c('el-col',{attrs:{"span":10}},[_c('span',{staticClass:"ml20",domProps:{"textContent":_vm._s(_vm.LANG['单日存款累计'] || '单日存款累计')}}),_vm._v(" "),_c('el-form-item',{staticClass:"to-inline-block",attrs:{"prop":'rule.luckydrawCondition[0].luckydraw['+key+'].total',"rules":[{ validator:_vm.validatorDepositNumber,trigger:'blur'}]}},[_c('el-input',{ref:"depositiInput",refInFor:true,staticClass:"intW",attrs:{"disabled":_vm.modeData.rule.type !=='1'},model:{value:(item.total),callback:function ($$v) {_vm.$set(item, "total", $$v)},expression:"item.total"}})],1)],1),_vm._v(" "),_c('el-col',{attrs:{"span":14}},[_c('span',{staticClass:"ml20",domProps:{"textContent":_vm._s(_vm.LANG['抽奖机会'] || '抽奖机会')}}),_vm._v(" "),_c('el-form-item',{staticClass:"to-inline-block",attrs:{"prop":'rule.luckydrawCondition[0].luckydraw['+key+'].times',"rules":[{ validator:_vm.validatorDepositNumber,trigger:'blur'}]}},[_c('el-input',{ref:"depositiInput",refInFor:true,staticClass:"intW",attrs:{"disabled":_vm.modeData.rule.type !=='1'},model:{value:(item.times),callback:function ($$v) {_vm.$set(item, "times", $$v)},expression:"item.times"}})],1),_vm._v(" "),_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['次'] || '次')}}),_vm._v(" "),(key === 0)?_c('i',{staticClass:"el-icon-plus",staticStyle:{"padding":"10px","background":"#ccc"},on:{"click":function($event){return _vm.addRule(key,0)}}}):_c('i',{staticClass:"el-icon-minus",staticStyle:{"padding":"10px","background":"#ccc"},on:{"click":function($event){return _vm.deleteRule(key,0)}}})],1)],1)})],2),_vm._v(" "),_c('el-radio',{staticClass:"lottery-condition radio",attrs:{"label":"2"}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['以投注为条件'] || '以投注为条件')}}),_vm._v(" "),_vm._l((_vm.modeData.rule.luckydrawCondition[1].luckydraw),function(item,key){return _c('div',{staticClass:"clear",staticStyle:{"padding-bottom":"15px"}},[_c('el-col',{attrs:{"span":10}},[_c('span',{staticClass:"ml20",domProps:{"textContent":_vm._s(_vm.LANG['单日投注累计'] || '单日投注累计')}}),_vm._v(" "),_c('el-form-item',{staticClass:"to-inline-block",attrs:{"prop":'rule.luckydrawCondition[1].luckydraw['+key+'].total',"rules":[{ validator:_vm.validatorBettingNumber,trigger:'blur'}]}},[_c('el-input',{ref:"depositiInput",refInFor:true,staticClass:"intW",attrs:{"type":"number","disabled":_vm.modeData.rule.type !=='2'},model:{value:(item.total),callback:function ($$v) {_vm.$set(item, "total", $$v)},expression:"item.total"}})],1)],1),_vm._v(" "),_c('el-col',{attrs:{"span":14}},[_c('span',{staticClass:"ml20",domProps:{"textContent":_vm._s(_vm.LANG['抽奖机会'] || '抽奖机会')}}),_vm._v(" "),_c('el-form-item',{staticClass:"to-inline-block",attrs:{"prop":'rule.luckydrawCondition[1].luckydraw['+key+'].total',"rules":[{ validator:_vm.validatorBettingNumber,trigger:'blur'}]}},[_c('el-input',{ref:"depositiInput",refInFor:true,staticClass:"intW",attrs:{"type":"number","disabled":_vm.modeData.rule.type !=='2'},model:{value:(item.times),callback:function ($$v) {_vm.$set(item, "times", $$v)},expression:"item.times"}})],1),_vm._v(" "),_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['次'] || '次')}}),_vm._v(" "),(key === 0)?_c('i',{staticClass:"el-icon-plus",staticStyle:{"padding":"10px","background":"#ccc"},on:{"click":function($event){return _vm.addRule(key,1)}}}):_c('i',{staticClass:"el-icon-minus",staticStyle:{"padding":"10px","background":"#ccc"},on:{"click":function($event){return _vm.deleteRule(key,1)}}})],1)],1)})],2),_vm._v(" "),_c('el-radio',{staticClass:"lottery-condition radio",attrs:{"label":"3"}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['以输钱为条件'] || '以输钱为条件')}}),_vm._v(" "),_vm._l((_vm.modeData.rule.luckydrawCondition[2].luckydraw),function(item,key){return _c('div',{staticClass:"clear",staticStyle:{"padding-bottom":"15px"}},[_c('el-col',{attrs:{"span":10}},[_c('span',{staticClass:"ml20",domProps:{"textContent":_vm._s(_vm.LANG['单日输钱累计'] || '单日输钱累计')}}),_vm._v(" "),_c('el-form-item',{staticClass:"to-inline-block",attrs:{"prop":'rule.luckydrawCondition[2].luckydraw['+key+'].total',"rules":[{ validator:_vm.validatorLoseNumber,trigger:'blur'}]}},[_c('el-input',{ref:"depositiInput",refInFor:true,staticClass:"intW",attrs:{"disabled":_vm.modeData.rule.type !=='3'},model:{value:(item.total),callback:function ($$v) {_vm.$set(item, "total", $$v)},expression:"item.total"}})],1)],1),_vm._v(" "),_c('el-col',{attrs:{"span":14}},[_c('span',{staticClass:"ml20",domProps:{"textContent":_vm._s(_vm.LANG['抽奖机会'] || '抽奖机会')}}),_vm._v(" "),_c('el-form-item',{staticClass:"to-inline-block",attrs:{"prop":'rule.luckydrawCondition[2].luckydraw['+key+'].total',"rules":[{ validator:_vm.validatorLoseNumber,trigger:'blur'}]}},[_c('el-input',{ref:"depositiInput",refInFor:true,staticClass:"intW",attrs:{"disabled":_vm.modeData.rule.type !=='3'},model:{value:(item.times),callback:function ($$v) {_vm.$set(item, "times", $$v)},expression:"item.times"}})],1),_vm._v(" "),_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['次'] || '次')}}),_vm._v(" "),(key === 0)?_c('i',{staticClass:"el-icon-plus",staticStyle:{"padding":"10px","background":"#ccc"},on:{"click":function($event){return _vm.addRule(key,2)}}}):_c('i',{staticClass:"el-icon-minus",staticStyle:{"padding":"10px","background":"#ccc"},on:{"click":function($event){return _vm.deleteRule(key,2)}}})],1)],1)})],2),_vm._v(" "),_c('el-radio',{staticClass:"lottery-condition radio",attrs:{"label":"4"}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['以赢钱为条件'] || '以赢钱为条件')}}),_vm._v(" "),_vm._l((_vm.modeData.rule.luckydrawCondition[3].luckydraw),function(item,key){return _c('div',{staticClass:"clear",staticStyle:{"padding-bottom":"15px"}},[_c('el-col',{attrs:{"span":10}},[_c('span',{staticClass:"ml20",domProps:{"textContent":_vm._s(_vm.LANG['单日赢钱累计'] || '单日赢钱累计')}}),_vm._v(" "),_c('el-form-item',{staticClass:"to-inline-block",attrs:{"prop":'rule.luckydrawCondition[3].luckydraw['+key+'].total',"rules":[{ validator:_vm.validatorWinNumber,trigger:'blur'}]}},[_c('el-input',{ref:"depositiInput",refInFor:true,staticClass:"intW",attrs:{"type":"number","disabled":_vm.modeData.rule.type !=='4'},model:{value:(item.total),callback:function ($$v) {_vm.$set(item, "total", $$v)},expression:"item.total"}})],1)],1),_vm._v(" "),_c('el-col',{attrs:{"span":14}},[_c('span',{staticClass:"ml20",domProps:{"textContent":_vm._s(_vm.LANG['抽奖机会'] || '抽奖机会')}}),_vm._v(" "),_c('el-form-item',{staticClass:"to-inline-block",attrs:{"prop":'rule.luckydrawCondition[3].luckydraw['+key+'].total',"rules":[{ validator:_vm.validatorWinNumber,trigger:'blur'}]}},[_c('el-input',{ref:"depositiInput",refInFor:true,staticClass:"intW",attrs:{"disabled":_vm.modeData.rule.type !=='4'},model:{value:(item.times),callback:function ($$v) {_vm.$set(item, "times", $$v)},expression:"item.times"}})],1),_vm._v(" "),_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['次'] || '次')}}),_vm._v(" "),(key === 0)?_c('i',{staticClass:"el-icon-plus",staticStyle:{"padding":"10px","background":"#ccc"},on:{"click":function($event){return _vm.addRule(key,3)}}}):_c('i',{staticClass:"el-icon-minus",staticStyle:{"padding":"10px","background":"#ccc"},on:{"click":function($event){return _vm.deleteRule(key,3)}}})],1)],1)})],2),_vm._v(" "),_c('el-radio',{staticClass:"radio",attrs:{"label":"5"}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['无条件'] || '无条件')}}),_vm._v(" "),_c('span',{staticClass:"ml20",domProps:{"textContent":_vm._s(_vm.LANG['抽奖机会'] || '抽奖机会')}}),_vm._v(" "),_c('el-form-item',{staticStyle:{"display":"inline-block"},attrs:{"prop":"rule.luckydrawCondition[4].times","rules":[{ validator:_vm.validatorNoConditionNumber,trigger:'blur'}]}},[_c('el-input',{ref:"noConditionInput",staticClass:"intW",attrs:{"type":"number","disabled":_vm.modeData.rule.type !=='5'},model:{value:(_vm.modeData.rule.luckydrawCondition[4].times),callback:function ($$v) {_vm.$set(_vm.modeData.rule.luckydrawCondition[4], "times", $$v)},expression:"modeData.rule.luckydrawCondition[4].times"}})],1),_vm._v(" "),_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['次'] || '次')}})],1)],1)],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"领取限制"}},[_c('el-radio-group',{on:{"change":function($event){return _vm.limitChange()}},model:{value:(_vm.get),callback:function ($$v) {_vm.get=$$v},expression:"get"}},[_c('el-radio',{staticClass:"radio",attrs:{"label":"1"}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['限定次数'] || '限定次数')}}),_vm._v(" "),_c('el-form-item',{staticStyle:{"display":"inline-block"},attrs:{"prop":"rule.limit_times","rules":[{ validator:_vm.validatorLimitNumber,trigger:'blur'}]}},[_c('el-input',{staticClass:"intW",model:{value:(_vm.modeData.rule.limit_times),callback:function ($$v) {_vm.$set(_vm.modeData.rule, "limit_times", $$v)},expression:"modeData.rule.limit_times"}})],1)],1),_vm._v(" "),_c('el-radio',{staticClass:"radio",attrs:{"label":"2"}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['无限定次数'] || '无限定次数')}})])],1)],1),_vm._v(" "),_c('el-form-item',{staticClass:"w80",attrs:{"label":"有效游戏范围","prop":"gameSelect"}},[_c('el-tree',{ref:"tree",attrs:{"data":_vm.tree,"show-checkbox":"","props":_vm.modeData.defaultProps,"node-key":"id","default-checked-keys":_vm.checkKeys,"default-expanded-keys":_vm.expandedKeys},on:{"check-change":_vm.handleCheckChange}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"有效会员等级","prop":"checkedDefut"}},[_c('el-checkbox',{attrs:{"indeterminate":_vm.isIndeterminate},on:{"change":_vm.handleCheckAllChange},model:{value:(_vm.modeData.vipType),callback:function ($$v) {_vm.$set(_vm.modeData, "vipType", $$v)},expression:"modeData.vipType"}},[_vm._v("全部\n                    ")]),_vm._v(" "),_c('div',{staticStyle:{"margin":"15px 0"}}),_vm._v(" "),_c('el-checkbox-group',{on:{"change":_vm.handleCheckedDefutChange},model:{value:(_vm.modeData.checkedDefut),callback:function ($$v) {_vm.$set(_vm.modeData, "checkedDefut", $$v)},expression:"modeData.checkedDefut"}},_vm._l((_vm.vipList),function(item,index){return _c('el-checkbox',{key:index,attrs:{"label":item.label,"name":"type"}})}),1)],1),_vm._v(" "),_c('el-form-item',{directives:[{name:"show",rawName:"v-show",value:(_vm.seachData.type=='add'),expression:"seachData.type=='add'"}],attrs:{"label":"发放时间","required":""}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['第'] || '第')}}),_vm._v(" "),_c('el-form-item',{staticClass:"to-inline-block",attrs:{"prop":"rule.issueTime","rules":[{ validator:_vm.validatorNumber,trigger:'blur'}]}},[_c('el-input',{staticClass:"intW",model:{value:(_vm.modeData.rule.issueTime),callback:function ($$v) {_vm.$set(_vm.modeData.rule, "issueTime", $$v)},expression:"modeData.rule.issueTime"}})],1),_vm._v(" "),_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['天发放'] || '天发放')}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"提款要求","prop":"rule.withdrawRequire"}},[_c('el-radio-group',{on:{"change":_vm.withdrawRequireChange},model:{value:(_vm.modeData.rule.withdrawRequire),callback:function ($$v) {_vm.$set(_vm.modeData.rule, "withdrawRequire", $$v)},expression:"modeData.rule.withdrawRequire"}},[_c('el-radio',{staticClass:"radio",attrs:{"label":"times"}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['倍数'] || '倍数')}}),_vm._v(" "),_c('el-form-item',{staticStyle:{"display":"inline-block"},attrs:{"prop":"rule.withdrawRequireVal","rules":[{ validator:_vm.validatorTimeNumber,trigger:'blur'}]}},[_c('el-input',{staticClass:"intW",model:{value:(_vm.modeData.rule.withdrawRequireVal),callback:function ($$v) {_vm.$set(_vm.modeData.rule, "withdrawRequireVal", $$v)},expression:"modeData.rule.withdrawRequireVal"}})],1)],1),_vm._v(" "),_c('el-radio',{staticClass:"radio",attrs:{"label":"bet"}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['固定投注流水'] || '固定投注流水')}}),_vm._v(" "),_c('el-form-item',{staticStyle:{"display":"inline-block"},attrs:{"prop":"rule.withdrawRequireVal1","rules":[{ validator:_vm.validatorBetNumber,trigger:'blur'}]}},[_c('el-input',{staticClass:"intW",model:{value:(_vm.modeData.rule.withdrawRequireVal1),callback:function ($$v) {_vm.$set(_vm.modeData.rule, "withdrawRequireVal1", $$v)},expression:"modeData.rule.withdrawRequireVal1"}})],1)],1),_vm._v(" "),_c('el-radio',{staticClass:"radio",attrs:{"label":"no"}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['无取款要求'] || '无取款要求')}})])],1)],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"状态"}},[_c('el-radio',{staticClass:"radio",attrs:{"label":"enabled"},model:{value:(_vm.modeData.status),callback:function ($$v) {_vm.$set(_vm.modeData, "status", $$v)},expression:"modeData.status"}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['启用'] || '启用')}})]),_vm._v(" "),_c('el-radio',{staticClass:"radio",attrs:{"label":"disabled"},model:{value:(_vm.modeData.status),callback:function ($$v) {_vm.$set(_vm.modeData, "status", $$v)},expression:"modeData.status"}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['停用'] || '停用')}})])],1)],1),_vm._v(" "),_c('el-col',{staticClass:"Layout",attrs:{"span":24}},[_c('h3',{staticClass:"tCent",domProps:{"textContent":_vm._s(_vm.LANG['内容设置'] || '内容设置')}}),_vm._v(" "),_c('el-form-item',{attrs:{"label":"优惠活动标题","prop":"title"}},[_c('el-input',{staticClass:"w80",model:{value:(_vm.modeData.title),callback:function ($$v) {_vm.$set(_vm.modeData, "title", $$v)},expression:"modeData.title"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"语言","prop":"language_id"}},[_c('el-select',{staticClass:"w80",attrs:{"placeholder":"请选择类型","disabled":""},on:{"change":_vm.changeLanguage},model:{value:(_vm.modeData.language_id),callback:function ($$v) {_vm.$set(_vm.modeData, "language_id", $$v)},expression:"modeData.language_id"}},_vm._l((_vm.languageList),function(item,index){return _c('el-option',{key:index,attrs:{"label":item.label,"value":item.value}})}),1)],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"优惠活动描述","prop":"description"}},[_c('el-input',{staticClass:"w80",attrs:{"type":"textarea"},model:{value:(_vm.modeData.description),callback:function ($$v) {_vm.$set(_vm.modeData, "description", $$v)},expression:"modeData.description"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"图片上传","prop":"cover"}},[_c('el-input',{staticStyle:{"display":"none"},model:{value:(_vm.modeData.cover),callback:function ($$v) {_vm.$set(_vm.modeData, "cover", $$v)},expression:"modeData.cover"}}),_vm._v(" "),_c('upload',{attrs:{"uploadUrl":_vm.uploadUrl,"keys":_vm.keys,"isInit":_vm.imgInit,"fileNum":1,"arrList":_vm.modeData.arrList,"imgResolution":'460*180'},on:{"response":_vm.doSaveFile}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":_vm.LANG['优惠规则编辑'] || '优惠规则编辑',"prop":"content"}},[_c('el-input',{staticStyle:{"display":"none"},model:{value:(_vm.modeData.content),callback:function ($$v) {_vm.$set(_vm.modeData, "content", $$v)},expression:"modeData.content"}}),_vm._v(" "),(_vm.pcshow)?_c('markdownEdit',{attrs:{"id":'pcid'},model:{value:(_vm.modeData.content),callback:function ($$v) {_vm.$set(_vm.modeData, "content", $$v)},expression:"modeData.content"}}):_vm._e()],1)],1)],1),_vm._v(" "),(_vm.seachData.type == 'add')?_c('el-col',{staticClass:"tCent",attrs:{"span":24}},[_c('el-button',{attrs:{"type":"primary","plain":true},on:{"click":function($event){return _vm.goBack(_vm.type = 'add')}}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['取消生成'] || '取消生成')}})]),_vm._v(" "),_c('el-button',{attrs:{"type":"primary"},on:{"click":function($event){return _vm.doSubmit(_vm.type = 'add')}}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['生成优惠'] || '生成优惠')}})])],1):_c('el-col',{staticClass:"tCent",attrs:{"span":24}},[_c('el-button',{attrs:{"type":"primary","plain":true},on:{"click":function($event){return _vm.goBack(_vm.type = 'edit')}}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['取消修改'] || '取消修改')}})]),_vm._v(" "),_c('el-button',{attrs:{"type":"primary"},on:{"click":function($event){return _vm.doSubmit(_vm.type = 'edit')}}},[_c('span',{domProps:{"textContent":_vm._s(_vm.LANG['保存修改'] || '保存修改')}})])],1)],1)],1)}
var staticRenderFns = []

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/component-normalizer.js
var component_normalizer = __webpack_require__(10);

// CONCATENATED MODULE: ./src/page/preAct/activeMode_4.vue
...
/* scopeId */
var __vue_scopeId__ = "data-v-f3eb8d44"
...
/* harmony default export */ var preAct_activeMode_4 = __webpack_exports__["default"] = (Component.exports);
