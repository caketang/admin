...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(107)("feb6f31c", content, true);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "pb"
  }, [_c('span', [_vm._v(_vm._s(_vm.LANG["彩种名称"] || "彩种名称"))]), _vm._v(" "), _c('el-select', {
    staticStyle: {
      "width": "200px"
    },
    attrs: {
    ...
    on: {
      "change": _vm.changeLottery
    },
    model: {
      value: (_vm.lottery_id),
      callback: function($$v) {
        _vm.lottery_id = $$v
      },
      expression: "lottery_id"
    }
  }, _vm._l((_vm.lotteryTypeList), function(item) {
    return _c('el-option', {
      key: item.id,
      staticStyle: {
        "width": "200px"
