...
( function(factory) {
    ...
    a(document).ready(function(){
        function v(a, b){
            return function(){
                ...
                if(1 == c.nodeType && ("textarea" == d || "input" == d && "text" == c.type)){
                    var e = [c].concat(Array.prototype.slice.call(arguments)), f = a.apply(this, e);
                    if(!b)return f
                }
        ...
        if(r().appendChild(s), m(s, "selectionStart") && m(s, "selectionEnd")) c = function(a){
            ...
            c = function(a){
                var d, e, f, g, b = 0, c = 0, h = document.selection.createRange();
            ...
            d = function(a, b, c){
                var d = p(a, b, c), e = a.createTextRange(), f = t(a, d.start);
