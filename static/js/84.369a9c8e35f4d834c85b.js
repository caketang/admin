...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      ...
      "tableUrl": _vm.tableModelUrl,
      "pageSet": false,
      "updated": _vm.updated,
      "showRefresh": false
    },
    on: {
      "do-Lock": _vm.doChanges
    }
  })], 1)], 1)], 1)
},staticRenderFns: []}
...
// module
exports.push([module.i, ".templateManage .cell .el-input__inner{width:140px}.templateManage .el-dialog--small{width:30%;min-width:400px;max-width:600px;border-radius:10px}.templateManage .el-dialog--small .fromMargin{margin-right:60px}.templateManage .bg-purple-dark{background:none}.templateManage .addManage{float:right;margin-right:5%}.templateManage .block{text-align:right}.templateManage .el-input{display:block}.templateManage .el-col{margin-bottom:20px}", ""]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(107)("0e14bc7c", content, true);
