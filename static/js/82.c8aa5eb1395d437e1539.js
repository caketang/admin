...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        dostart(row) {
            ...
            row.status == '1' && this.$http.patch(formDataUrl, doStop, URLCONFIG).then(res => {
            ...
            row.status == '0' && this.$http.patch(formDataUrl, doStart, URLCONFIG).then(res => {
                if (res.data.data && res.data.state === 0) {
                    this.$message.success(this.LANG['状态改变成功！'] || '状态改变成功！');
                    //刷新数据
                    this.updataTable = true;
...
// module
exports.push([module.i, ".currencyMain[data-v-6eb9419c]{padding:0 10px}", ""]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(107)("1d81508d", content, true);
