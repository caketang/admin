...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        init() {
            ...
            if (this.bodyModelUrl != "" && this.bodyModelUrl != null) {
                ...
                this.$http.get(bodyurl, URLCONFIG).then(res => {
                    _this.bodyModel = res.data.data || [];
                    this.allshow = this.getchecks('visibility') === this.bodyModel.length;
                    this.allrequire = this.getchecks('necessity') === this.bodyModel.length;
                    this.allValidate = this.getchecks('validate') === 6;
                }).catch(err => {
                    _this.$message.error(LANG['未知错误，请稍后重试！'] || '未知错误，请稍后重试！');
                });
            };
            ...
            //表头
            this.$http.get(this.headModel, URLCONFIG).then(res => {
                _this.oColumn = res.data.columns || [];
            }).catch(err => {
                _this.$message.error(LANG['未知错误，请稍后重试！'] || '未知错误，请稍后重试！');
            });
        },
        //列全选事件
        checkAllChange(val, prop) {
            for (let k in this.bodyModel) {
                if (prop === 'validate') {
                    if (this.bodyModel[k]['item'] === 'name' || this.bodyModel[k]['item'] === 'email' || this.bodyModel[k]['item'] === 'mobile' || this.bodyModel[k]['item'] === 'skype' || this.bodyModel[k]['item'] === 'weixin' || this.bodyModel[k]['item'] === 'qq') {
                        this.bodyModel[k][prop] = val;
                    }
                } else {
                    this.bodyModel[k][prop] = val;
                }
        ...
        //点击check事件
        changeCange(val, prop) {
            if (prop === 'visibility') {
                this.allshow = this.getchecks(prop) === this.bodyModel.length;
            } else if (prop === 'necessity') {
                this.allrequire = this.getchecks(prop) === this.bodyModel.length;
            } else {
                this.allValidate = this.getchecks(prop) === 3;
            }
        },
        getchecks(prop) {
            let num = 0;
            for (let k in this.bodyModel) {
                if (this.bodyModel[k][prop]) {
                    num++;
                }
            }
            return num;
        ...
        doSave() {
            this.$emit('save-data', { "item": this.bodyModel });
        }
    },
    created: function () {
        this.init();
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__systemSettings_modelSet_vue__ = __webpack_require__(943);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__systemSettings_modelSet_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__systemSettings_modelSet_vue__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        modelset: __WEBPACK_IMPORTED_MODULE_0__systemSettings_modelSet_vue___default.a,
    ...
    methods: {
        ...
        saveData(data) {
            ...
            if (data['item']) {
                ...
                let _this = this;
                let url = URL.api + ROUTES.PATCH.system.registration;
                this.$http.patch(url, JSON.stringify(temp), URLCONFIG).then(res => {
...
// module
exports.push([module.i, ".templateManage .el-dialog--small{width:30%;min-width:400px;max-width:600px;border-radius:10px}.templateManage .el-dialog--small .fromMargin{margin-right:60px}.templateManage .bg-purple-dark{background:none}.templateManage .addManage{float:right;margin-right:5%}.templateManage .block{text-align:right}.el-checkbox{margin-left:10px}.templateManage .el-col{margin-bottom:10px}.btn-active{background-color:#0197d2}", ""]);
...
// module
exports.push([module.i, ".three[data-v-2ab287d7]{width:400px}", ""]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(107)("3561772e", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(107)("7694608c", content, true);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v(_vm._s(_vm.LANG['代理注册'] || '代理注册'))]), _vm._v(" "), _c('el-radio', {
    attrs: {
      "label": "user"
    }
  }, [_vm._v(_vm._s(_vm.LANG['会员注册'] || '会员注册'))])], 1)], 1), _vm._v(" "), _c('el-col', {
    staticClass: "mt10"
  }, [_c('el-button', {
    attrs: {
      "size": "small",
      "type": (_vm.numberType === 'pc' ? 'primary' : '')
    },
    on: {
      "click": function($event) {
        _vm.setNumberType('pc')
      }
    }
  }, [_vm._v("PC")]), _vm._v(" "), _c('el-button', {
    attrs: {
      "size": "small",
      "type": (_vm.numberType === 'h5' ? 'primary' : ''),
      "disabled": (_vm.radio === 'agent')
    },
    on: {
      "click": function($event) {
        _vm.setNumberType('h5')
      }
    }
  }, [_vm._v("H5")])], 1), _vm._v(" "), _c('el-col', {
    attrs: {
      "span": 24
    }
  }, [_c('modelset', {
    attrs: {
      "headModel": _vm.columnsUrl,
      "bodyModelUrl": _vm.tableUrl
    },
    on: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    domProps: {
      "textContent": _vm._s(_vm.LANG['保存'] || '保存')
    },
    on: {
      "click": _vm.doSave
    }
  }), _vm._v(" "), _c('table', {
    staticClass: "el-table el-table__header tCent w100",
    attrs: {
      "cellspacing": "0",
      "cellpadding": "0",
      "border": "0"
    ...
    staticClass: "is-leaf three",
    attrs: {
      "colspan": "1",
      "rowspan": "1"
    }
  }, [_c('div', [_vm._v(_vm._s(_vm.LANG['注册内容'] || '注册内容'))])]), _vm._v(" "), _c('th', {
    staticClass: "is-leaf three",
    attrs: {
      "colspan": "1",
      "rowspan": "1"
    }
  }, [_c('div', [_vm._v(_vm._s(_vm.LANG['是否显示'] || '是否显示')), _c('el-checkbox', {
    on: {
      "change": function($event) {
        _vm.checkAllChange(_vm.allshow, 'visibility')
      }
    },
    model: {
      value: (_vm.allshow),
  ...
  }, [_c('div', [_vm._v(_vm._s(_vm.LANG['是否必填'] || '是否必填')), _c('el-checkbox', {
    on: {
      "change": function($event) {
        _vm.checkAllChange(_vm.allrequire, 'necessity')
      }
    },
    model: {
      value: (_vm.allrequire),
      callback: function($$v) {
        _vm.allrequire = $$v
      },
      expression: "allrequire"
    }
  })], 1)]), _vm._v(" "), _c('th', {
    staticClass: "is-leaf three",
    attrs: {
  ...
  }, [_c('div', [_vm._v(_vm._s(_vm.LANG['是否验证'] || '是否验证')), _c('el-checkbox', {
    on: {
      "change": function($event) {
        _vm.checkAllChange(_vm.allValidate, 'validate')
      }
    },
    model: {
      value: (_vm.allValidate),
      callback: function($$v) {
        _vm.allValidate = $$v
      },
      expression: "allValidate"
    }
  })], 1)])])]), _vm._v(" "), _c('table', {
    staticClass: "el-table__body el-table w100",
    attrs: {
      "cellspacing": "0",
      "cellpadding": "0",
      "border": "0"
    }
  }, _vm._l((_vm.bodyModel), function(item, k) {
    return _c('tr', _vm._l((_vm.oColumn), function(col, index) {
      return _c('td', {
        staticClass: "el-table_1_column_19 three"
      }, [_c('div', {
        staticClass: "cell"
      }, [(!col.checkbox && !col.number) ? _c('span', [_vm._v(_vm._s(_vm.LANG[item[col.prop]] || item[col.prop]))]) : _vm._e(), _vm._v(" "), (col.checkbox && col.prop !== 'validate') ? _c('el-checkbox', {
        attrs: {
          "disabled": item['visibility'] == false && col.prop == 'necessity'
        },
        on: {
          "change": function($event) {
            _vm.changeCange(item[col.prop], col.prop)
          }
        },
        model: {
          value: (item[col.prop]),
      ...
      }) : _vm._e(), _vm._v(" "), (col.checkbox && col.prop === 'validate' && (item['item'] === 'name' || item['item'] === 'email' || item['item'] === 'mobile' || item['item'] === 'qq' || item['item'] === 'weixin' || item['item'] === 'skype')) ? _c('el-checkbox', {
        attrs: {
          "disabled": item['visibility'] == false
        },
        on: {
          "change": function($event) {
            _vm.changeCange(item[col.prop], col.prop)
