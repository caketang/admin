<template>
    <div id="timePicker">
        <span class="time-picker">
            <i class="el-input__icon  el-icon-circle-close closeIcon" v-if="!hideClearButton" v-show="!showDropdown && showClearBtn" @click.stop="clearTime"></i>
        <input class="display-time  el-input__inner" :id="id" v-model="displayTime" @click.stop="toggleDropdown" type="text" readonly />
