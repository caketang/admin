<template>
    <ul id="message">
        ...
        <li>
            ...
            <el-tooltip class="item" effect="light" :content="LANG['消息总数'] || '消息总数' " placement="bottom" style="z-index:2000;">
				...
				this.$.autoAjax('get',url, '', {
					ok: (res) => {
						if (res.state == 0 && res.data) {
							let audioPlay = document.querySelector('#audioPlay'), audioPlay2 = '', audioPlay3 = '';
