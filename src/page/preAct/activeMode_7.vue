            ...
            <el-form ref="form" :model="modeData" :rules="rules" label-width="140px" class="mt20">
                <el-col :span="24" class="Layout">
                    ...
                    <el-form-item label="优惠规则" required>
                        <div v-for="(item,key) in modeData.rule.rule" class="addPadding">
                            <el-form-item :prop=" 'rule.rule['+key+'].money' " :rules="[{ validator:validatorNumber,trigger:'blur'}]" class="to-inline-block addPadding">
                                <span v-text="LANG['单注中奖金额'] || '单注中奖金额'"></span>
                                <el-input  class="ruleInput"  v-model="item.money"></el-input>
                            </el-form-item>
                            <el-form-item :prop=" 'rule.rule['+key+'].type' " class="to-inline-block w100">
                                <el-radio-group v-model="item.type" @change="typeChange">
                                    <el-radio  label="1" class="radio">
                                        <span v-text="LANG['比例'] || '比例'"></span>
                                        <el-form-item :prop=" 'rule.rule['+key+'].upper_limit' " :rules="[{ validator:validatorTypeNumber,trigger:'blur'}]" class="to-inline-block">
                                            <el-input v-model="item.upper_limit" class="ruleInput" @blur="inputBlur(key)" ref="percentInput"></el-input>%
                                        </el-form-item>
                                        <span v-text="LANG['上限'] || '上限'"></span>
                                        <el-form-item :prop=" 'rule.rule['+key+'].prize' " :rules="[{ validator:validatorTypeNumber,trigger:'blur'}]" class="to-inline-block">
                                            <el-input v-model="item.prize" class="ruleInput" ref="percentInput"></el-input>
                                        </el-form-item>
                                    </el-radio>
                                    <el-radio  label="2" class="radio">
                                        <span v-text="LANG['固定金额'] || '固定金额'"></span>
                                        <el-form-item :prop=" 'rule.rule['+key+'].prize' " :rules="[{ validator:validatorMoneyNumber,trigger:'blur'}]" class="to-inline-block">
                                            <el-input v-model="item.prize1" class="ruleInput" @blur="inputBlur(key)" ref="percentInput"></el-input>
                                        </el-form-item>
                    ...
                    <el-form-item label="领取限制">
                        <el-radio-group v-model="get" @change="limitChange()">
                            <el-radio  label="1" class="radio">
                                ...
                                <el-form-item prop="rule.limit_times" :rules="[{ validator:validatorLimitNumber,trigger:'blur'}]" class="to-inline-block">
                    ...
                    <el-form-item label="提款要求" prop="rule.withdrawRequire">
                        <el-radio-group v-model="modeData.rule.withdrawRequire" @change="withdrawRequireChange">
                            <el-radio  label="times" class="radio">
                                ...
                                <el-form-item class="to-inline-block" prop="rule.withdrawRequireVal" :rules="[{ validator:validatorTimeNumber,trigger:'blur'}]">
                            ...
                            <el-radio  label="bet" class="radio">
                                ...
                                <el-form-item class="to-inline-block" prop="rule.withdrawRequireVal1" :rules="[{ validator:validatorBetNumber,trigger:'blur'}]">
                ...
                <el-col :span="24" class="Layout">
                    ...
                    <el-form-item :label="LANG['优惠规则编辑'] || '优惠规则编辑'" prop="content">
                        ...
                        <markdownEdit  v-model="modeData.content" v-if="pcshow" :id="'pcid'"></markdownEdit>
                    </el-form-item>
                </el-col>
            </el-form>
