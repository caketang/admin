                ...
                <el-col :span="24" class="Layout">
                    ...
                    <el-form-item label="优惠规则" required>
                        <div class="addPadding">
                            <span v-text="LANG['最小投注金额'] || '最小投注金额'"></span>
                            <el-form-item class="to-inline-block" prop="rule.rule.minBetMoney">
                                <el-input  class="intW" type="number" v-model="modeData.rule.rule.minBetMoney"></el-input>
                            </el-form-item>
                        </div>
                        <div v-for="(item,key) in modeData.rule.rule.prize" class="addPadding">
                            <span v-text="LANG['连赢次数'] || '连赢次数'"></span>
                            <el-form-item class="to-inline-block" :prop=" 'rule.rule.prize['+key+'].times' " :rules="[{ validator:validatorNumber,trigger:'blur'}]">
                                <el-input v-model="item.times" class="intW" type="number"></el-input>
                            </el-form-item>
                            <span v-text="LANG['优惠金额'] || '优惠金额'"></span>
                            <el-form-item class="to-inline-block" :prop=" 'rule.rule.prize['+key+'].money' " :rules="[{ validator:validatorNumber,trigger:'blur'}]">
                                <el-input  class="intW" type="number" v-model="item.money"></el-input>
                            </el-form-item>
...
//                checkAll: true,//全选会员等级
                ...
                rules: {
                    ...
                    'rule.rule.minBetMoney':[
                        { required: true, message: '请填写最小投注金额', trigger : 'blur' }
                    ],
                    checkedDefut:[
