        ...
        <el-col :span="14" :offset="5" class="activeModeForm">
            <el-form ref="form" :model="modeData" :rules="rules" label-width="140px" class="mt20">
                <el-col :span="24" class="Layout">
                    ...
                    <el-form-item label="优惠规则" prop="rule.rule" required class="w100">
                        <div v-for="(item,key) in modeData.rule.rule">
                            <div class="clear" style="padding-bottom: 15px;">
                                <el-col :span="10">
                                    <el-form-item :prop=" 'rule.rule['+key+'].money' " :rules="[{ validator:validatorNumber,trigger:'blur'}]">
                                        <span v-text="LANG['输钱累计'] || '输钱累计'"></span>
                                        <el-input v-model="item.money" class="intW"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="14">
                                    <el-form-item :prop=" 'rule.rule['+key+'].prize' " :rules="[{ validator:validatorNumber,trigger:'blur'}]">
                                        <span v-text="LANG['救援金'] || '救援金'"></span>
                                        <el-input v-model="item.prize" class="intW"></el-input>
                    ...
                    <el-form-item label="提款要求" prop="rule.withdrawRequire">
                        <el-radio-group v-model="modeData.rule.withdrawRequire" @change="withdrawRequireChange">
                            ...
                            <el-radio  label="no"><span v-text="LANG['无取款要求'] || '无取款要求'"></span></el-radio>
                        </el-radio-group>
                    </el-form-item>
