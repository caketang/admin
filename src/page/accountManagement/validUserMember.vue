<template>
    <div id="validUser">
        <el-col v-if="activeName == 'member' && !showDetail">
            <formEdit :formVisible="{}"
                          ...
                          <div style="width: 100%; height: 38px;" v-if="isShow">
                              <el-button type="primary" size="small" style="float: right;" @click="exportData('member')">{{LANG['导出'] || '导出'}}</el-button>
                          </div>
        ...
        <el-col v-if="showDetail">
            <validUserDetail :nowId="nowId" :agentNames="agentNames" :activeName="activeName"  @return-page="returnList" :stime="stimes" :etime="etimes"></validUserDetail>
        </el-col>
    </div>
</template>
<script>
        ...
        data() {
            return {
                ...
                formConfigUser:[
                    ...
                    {"prop":"name","value":"","type":"textarea","label":"帐号","placeholder":"输入会员账号，多个会员帐号之间用英文逗号 , 隔开","width":500},
