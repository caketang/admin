<template>
    <div id="fieldSettings">
        <el-row>
            <el-col :span="24">
                <el-form ref="form" :model="globBase" label-width="140px" class="w50" style="min-width:580px;margin: 0 auto;">
                            ...
                            <el-col :span="12">
                                <div class="grid-content">
                                    <el-form-item :label="LANG['登录密码容错次数'] || '登录密码容错次数'">
                                        <el-input type="number" class="setInput" v-model="globBase.password_login_fault"></el-input>
                                    </el-form-item>
                                </div>
                                <div class="grid-content">
                            ...
                            <el-col :span="12">
                                ...
                                <div class="grid-content">
                                    <el-form-item :label="LANG['取款密码容错次数'] || '取款密码容错次数'">
                                        <el-input type="number" v-model="globBase.password_withdraw_fault" class="setInput"></el-input>
                                    </el-form-item>
                                </div>
                                <div class="grid-content">
                                    <el-form-item :label="LANG['同IP注册会员数'] || '同IP注册会员数'">
                                        <el-input type="number" v-model="globBase.ip" class="setInput"></el-input>
                        ...
                        <el-row class="tCent">
                            <el-col :span="24">
                                <div class="grid-content title">
                                    <span style="color: #48576a">{{LANG['有效投注出款稽核核算比例'] || '有效投注出款稽核核算比例'}}（%)</span>
                                </div>
                            </el-col>
                        </el-row>
                        <el-row>
                            <el-col :span="12">
                                <div class="grid-content">
                                    <el-form-item :label="LANG['体育'] || '体育'"
                                        ...
                                        <el-input max="200" min="0" type="number" class="setInput" v-model="betData.sport"></el-input>
                                    </el-form-item>
                                ...
                                <div class="grid-content">
                                    <el-form-item :label="LANG['视讯'] || '视讯'"
                                        ...
                                        <el-input max="200" min="0" type="number" class="setInput" v-model="betData.live"></el-input>
                                    </el-form-item>
                            ...
                            <el-col :span="12">
                                <div class="grid-content">
                                    <el-form-item :label="LANG['彩票'] || '彩票'"
                                        ...
                                        <el-input max="200" min="0" type="number" class="setInput" v-model="betData.lottery"></el-input>
                                    </el-form-item>
                                ...
                                <div class="grid-content">
                                    <el-form-item :label="LANG['电子'] || '电子'"
                                        ...
                                        <el-input max="200" min="0" type="number" class="setInput" v-model="betData['e-sports']"></el-input>
                                    </el-form-item>
                                    <span v-if="betData['e-sports'] ==''||betData['e-sports']>200 || betData['e-sports']< 0"
                                          class="font12 tRight ruleTitle">请输入0～200的稽核核算比例</span>
...
//                        let tmepOne = this.globBase.start_day.split(' ')
            ...
            setSwitch(value) {
//                if (value) {
//                    this.globBase.maintaining_start_time = ""
//                        this.globBase.maintaining_end_time = "";
//                }
            },
            //分割数据
            cutGamesData() {
...
//                valid_bet_percent_arr.push(`${this.submitData.base['valid_bet_percent']['e-sports']}`);
//                valid_bet_percent_arr.push(`${this.submitData.base['valid_bet_percent']['live']}`);
//                valid_bet_percent_arr.push(`${this.submitData.base['valid_bet_percent']['lottery']}`);
//                valid_bet_percent_arr.push(`${this.submitData.base['valid_bet_percent']['sport']}`);
//                    if (this.submitData.base.maintaining = true && this.submitData.base.maintaining_start_time === '' && this.submitData.base.maintaining_end_time === '') {
