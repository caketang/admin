        ...
        <table cellspacing="0" cellpadding="0" border="0" class="el-table el-table__header el-table--border" style="width: 100%;">
                <thead>
                    ...
                    <tr v-for="(item,index) in dataModel" v-if="dataModel.length">
                        <td colspan="2" class="el-table_1_column_19">
                            <div class="cell tCent" >
                                <span  class="link" v-if="item.type==='member'" @click="showMember">直属会员</span>
                                <span  class="link" v-if="item.type==='agent'" @click="showAgent">直属代理</span>
                                <span class="link" v-if="item.type==='level_agent'" @click="showLevelAgent">层级代理</span>
                            </div>
                        </td>
                        <td colspan="2" class="el-table_1_column_19">
                            <div class="cell tCent" >
                        ...
                        <td colspan="2" class="el-table_1_column_19">
                            <div class="cell tCent" >
                                <span :class="{state_danger: parseFloat(item.lose_earn) < 0 }">{{item.lose_earn | formatMoney}}</span>
                            </div>
                        </td>
                        <td colspan="2" class="el-table_1_column_19">
                            <div class="cell tCent" >
                    ...
                    <tr v-if="dataModel.length">
                        ...
                        <td colspan="2" class="el-table_1_column_19">
                            <div class="cell tCent" >
                                <span :class="{state_danger: parseFloat(totalData.lose_earn) < 0 }">{{totalData.lose_earn | formatMoney}}</span>
                            </div>
                        </td>
                        <td colspan="2" class="el-table_1_column_19">
                            <div class="cell tCent" >
