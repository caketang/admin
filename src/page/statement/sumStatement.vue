<template>
    <div class="page">
        ...
        <el-col v-if="isDetail">
            <memberdetails :Url="detailsUrl" :label="detailslabel" :type="showtype" :agentUrl="agentUrl"
                           ref="reload"></memberdetails>
        </el-col>
        <!--层级代理-->
        <el-col v-if="levelAgent">
            <levelagent :Url="detailsUrl" :label="detailslabel" :date="label" 　:fUrl="firstUrl"
                        ref="child"></levelagent>
        </el-col>
    </div>
</template>
<script>
