<template>
    <el-card class="box-card">
        <div id="depositStatus">
            <div>
                <el-button type="primary" icon="arrow-left" size="small" @click="returnPage">{{LANG['返 回'] || '返 回'}}
                </el-button>
                <span>{{paymentName}} </span>{{LANG['存款状况'] || '存款状况'}}
            </div>
            <el-col class="mt10">
                <formEdit :formVisible="formVisible" :formConfig="searchConfig" :type="type"
                          :isEdit="isEdit" :labelWidth="labelWidth" @do-query="doQuery" @reset-form="resetForm"
            ...
            <el-row>
                <el-col class="lists">
                    ...
                    <el-table :data="sumData" border class="mt10" style="max-width: 1080px">
            ...
            <el-row>
                <el-col class="lists">
                    ...
                    <tablegrid
                        ...
                        :updated="updated">
                        <div slot="other" v-if="slotShow">小计：{{sumData[0].subTotalMoney ? sumData[0].subTotalMoney : 0}}
                        </div>
                    </tablegrid>
                </el-col>
            </el-row>
