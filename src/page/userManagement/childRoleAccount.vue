                ...
                checkExportList: [
                    {
                        ...
                        checkedChildren: [],
                        childrenStatus: [
                            {cn_name: "有效用户导出", en_name: "valid_user_export", status: false},
                            {cn_name: "优惠申请导出", en_name: "active_applys_export", status: false},
                            {cn_name: "线上充值导出", en_name: "deposit_onlines_export", status: false},
                            {cn_name: "公司入款导出", en_name: "deposit_offlines_export", status: false},
                            {cn_name: "会员提现导出", en_name: "user_withdraws_export", status: false},
                            {cn_name: "返水导出", en_name: "rebate_details_export", status: false}
                            ]
                    }
                ]
            }
